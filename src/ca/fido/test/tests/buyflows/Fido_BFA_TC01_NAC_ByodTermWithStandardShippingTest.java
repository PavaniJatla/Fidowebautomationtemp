...
public class Fido_BFA_TC01_NAC_ByodTermWithStandardShippingTest extends BaseTestClass{
	...
	public void fidoNACFlow() {
		...
		getReporter().hardAssert(getFidochoosephonepage().selectDevice(TestDataHandler.tc01ByodStandardShipping.getDeviceName()),"Device Found and Selected","Device Not Found");
