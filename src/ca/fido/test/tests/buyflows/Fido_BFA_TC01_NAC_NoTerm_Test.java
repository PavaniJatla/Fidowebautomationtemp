...
public class Fido_BFA_TC01_NAC_NoTerm_Test extends BaseTestClass{
	...
	public void fidoNACFlow() {
		...
		getReporter().hardAssert(getFidochoosephonepage().selectDevice(TestDataHandler.testCase01.getDeviceName()),"Device Found and Selected","Device Not Found");
		...
		getFidocreateuserpage().setHomeAddress(TestDataHandler.testCase01.getBillingAddress());
		...
		getFidocreditcheckpage().selectDrivingLicenseProvince(TestDataHandler.testCase01.getDlProvinceCode());
		getFidocreditcheckpage().setDrivingLicenseNumber(TestDataHandler.testCase01.getDlProvinceCode());
		...
		getFidochoosenumberpage().selectCity(TestDataHandler.testCase01.getCtnCity());
