...
public class Fido_BFA_TC13_HUPWithPPCKeepExistingUsingFinancePlanExpressShipping_Test extends BaseTestClass {
    ...
    public void hupWithPPC_KeepExistingUsingFinancePlanStandardShippingFlowTest() {
        ...
        getFidologinpage().setUsernameInFrame(TestDataHandler.tc10HupExistingSubsidy2.getUsername());
        getFidologinpage().setPasswordInFrame(TestDataHandler.tc10HupExistingSubsidy2.getPassword());
...
/*        getFidoaccountoverviewpage().clkViewUsageAndManageLink();
        ...
        String deviceName = TestDataHandler.tc10HupExistingSubsidy2.getNewDevice();
        ...
        String ctn = TestDataHandler.tc10HupExistingSubsidy2.getCtn();
        ...
        String deviceCostIndex = TestDataHandler.tc10HupExistingSubsidy2.getDeviceCostIndex();
