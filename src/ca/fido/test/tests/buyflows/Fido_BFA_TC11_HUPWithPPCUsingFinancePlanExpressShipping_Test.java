...
public class Fido_BFA_TC11_HUPWithPPCUsingFinancePlanExpressShipping_Test extends BaseTestClass {
...
/*        getFidoaccountoverviewpage().clkViewUsageAndManageLink();
        ...
        String deliveryMethod = TestDataHandler.tc11HupPpcFinancingExpressShipping.getShippingType();
