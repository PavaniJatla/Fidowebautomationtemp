...
public class FidoSS_Regression_TC089_ValidateDeviceSectionAndDeviceDetailsModalForCXWithFinanceNotPaid_OFF_ON extends BaseTestClass{
    ...
    public void postPaidDashBoardValidateFullyFinancedDevice() throws SSLHandshakeException, ClientProtocolException, IOException, InterruptedException {
        ...
        String userName = "Autodatar421BFA42@yahoo.com";
        ...
        String strCTN = "4168200365";//TestDataHandler.tc04_PostPaidFinancePaidOff.getaccountDetails().getCtn();
