...
public class Fido_BFA_TC03_AALTermTabletFinancingStandardShipping_Test extends BaseTestClass {
    ...
    public void aalTermTabletFinancingStandardShippingFlow() {
        ...
        getFidoOVPlanConfigPage().selectDeviceCostAndClickOnContinueButton(getFidoOVPlanConfigPage().getUpdatedDeviceCostIndex(TestDataHandler.tc01AalByodFinancingBopisShipping.getDeviceCostIndex()));
